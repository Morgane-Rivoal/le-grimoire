...
const plantKnowledgeProfiles = [
  {
    ...
    status:"toxique",
    flowering:"Juin à juillet",
    height:"90 cm à 1,5 m",
    recognition:"Plante dressée issue d’un bulbe, portant des feuilles lancéolées le long de la tige et de grandes fleurs à six tépales. Les fleurs, souvent en trompette ou en coupe, présentent six étamines très visibles chargées de pollen.",
  ...
  },
  {
    ...
    height:"1 à 2 m, parfois davantage selon la variété",
    recognition:"Arbuste caduc aux grandes feuilles opposées, ovales et nettement dentées. Les petites fleurs sont regroupées en larges inflorescences arrondies ou aplaties, bleues, roses, violettes ou blanches selon la variété et le sol.",
  ...
  },
  {
    ...
    height:"30 à 80 cm",
    recognition:"Herbacée à tiges souvent quadrangulaires et feuilles opposées, dentées, vert soutenu. Le feuillage libère une odeur fraîche et mentholée très marquée lorsqu’il est froissé.",
  ...
  },
  {
    ...
    height:"40 à 80 cm",
    recognition:"Sous-arbrisseau compact à feuilles étroites gris-vert. Les petites fleurs violettes sont réunies en épis au sommet de longues tiges et dégagent un parfum caractéristique.",
  ...
  },
  {
    ...
    edibility:"Comestible comme aromate, si la plante est bien confirmée",
    status:"comestible",
    flowering:"Hiver à printemps",
    height:"50 cm à 1,5 m",
    recognition:"Arbrisseau persistant aux feuilles très étroites, coriaces, vert foncé dessus et blanchâtres dessous. Les fleurs bleu pâle à violacées apparaissent à l’aisselle des feuilles et le feuillage dégage une odeur résineuse.",
  ...
  },
  {
    ...
    height:"10 à 30 cm",
    recognition:"Petit sous-arbrisseau tapissant aux tiges ligneuses et aux très petites feuilles opposées. Les fleurs rosées ou mauves sont regroupées en petits verticilles et le feuillage possède une odeur chaude et puissante.",
  ...
  },
  {
    ...
    status:"prudence",
    flowering:"Juin à août, la deuxième année",
    height:"20 à 40 cm",
    recognition:"Herbacée en rosette puis dressée, aux feuilles triangulaires très découpées, plates ou frisées. Les fleurs de deuxième année sont petites, jaune-vert, disposées en ombelles.",
  ...
  },
  {
    ...
    status:"prudence",
    flowering:"Mai à octobre selon la variété",
    height:"50 cm à plusieurs mètres selon le port",
    recognition:"Arbuste à tiges souvent munies d’aiguillons, portant des feuilles composées de folioles dentées. Les fleurs possèdent cinq pétales chez les formes sauvages et de nombreux pétales chez les variétés horticoles.",
